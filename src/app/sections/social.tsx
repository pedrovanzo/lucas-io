            ...
            <ul className="m-auto w-fit flex flex-row items-center gap-4 sticky top-0 p-4 rounded-md bg-neutral-900 text-white z-10">
                {pathname !== '/' && (
                    <Link href="/" className="text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" data-social-icons fill="#fff" version="1.1" id="Capa_1" width="80px" height="80px" viewBox="0 0 495.398 495.398" xmlSpace="preserve">
                            <g>
                                <g>
                                    <g>
